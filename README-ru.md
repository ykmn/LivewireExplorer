...
Для фазоскопа предусмотрена ручка усиления входного уровня x1...x12 - только для улучшения картинки.

## Кэш, настройки и логи

Все рабочие файлы приложения лежат рядом с `.exe`, а не в `%LOCALAPPDATA%` или Program Files — это позволяет приложению работать как портативное и не зависеть от прав на запись в системные папки:
...
Вы можете редактировать эти файлы вручшую соблюдая синтаксис YAML или удалить, они создадутся 
